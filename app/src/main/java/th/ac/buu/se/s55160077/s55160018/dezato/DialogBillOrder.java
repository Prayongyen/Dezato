...
/**
 * Created by LUKHIBB on 22/4/2558.
 */
public class DialogBillOrder  extends ListFragment {
    String[] list_items;
     ...
     * number.
     */
    public static DialogBillOrder newInstance(int sectionNumber) {
        DialogBillOrder fragment = new DialogBillOrder();
...
//            }
            ...
            {
                DialogBillOrderAdapter adapter = new DialogBillOrderAdapter(getActivity(), mItems);
